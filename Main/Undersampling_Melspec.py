...
make_train_plot('UndersamplingMelspec', 'CNN', history, 0)
...
make_train_plot('UndersamplingMelspec', 'Resnet', history_resnet, 1)
...
make_train_plot('UndersamplingMelspec', 'VGGish', history_vggish, 2)
...
printToFile('Undersampling_Melspec.txt')