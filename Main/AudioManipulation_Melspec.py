...
# trainAudioFileList = ['Train_Audio_3.lz4']
...
make_train_plot('ManipMelspec', 'CNN', history, 0)
...
make_train_plot('ManipMelspec', 'Resnet', history_resnet, 1)
...
make_train_plot('ManipMelspec', 'VGGish', history_vggish, 2)
...
printToFile('AudioManipulation_Melspec.txt')