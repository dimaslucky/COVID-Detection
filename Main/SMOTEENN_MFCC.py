...
X_train, X_train_val, X_test = extract_mfcc(X_train_res, X_train_val, X_test)
...
make_train_plot('SMOTEMFCC', 'CNN', history, 0)
...
make_train_plot('SMOTEMFCC', 'Resnet', history_resnet, 1)
...
make_train_plot('SMOTEMFCC', 'VGGish', history_vggish, 2)
